    ...
    if(e.classList.remove("no-js"),e.classList.add("js"),document.body.classList.contains("has-animations")){
      (window.sr=ScrollReveal()).reveal(".feature, .pricing-table-inner", {
        ...
        beforeReveal: function (domEl) {
          // Remove loading class before revealing
          e.classList.remove("anime-ready");
        },
        beforeReset: function (domEl) {
          // Add loading class before resetting
      ...
      anime.timeline({targets:".hero-figure-box-05"})
        .add({duration:400,easing:"easeInOutExpo",scaleX:[.05,.05],scaleY:[0,1],perspective:"500px",delay:anime.random(0,400)})
